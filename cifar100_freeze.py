...
from models import *
from utils import progress_bar, partial_load, freeze_layer, freeze_bn
...
if args.pretrain:
    partial_load(net, torch.load(args.pretrain)['net'], args.pretrain_layer)
    freeze_layer(net, args.pretrain_layer)
